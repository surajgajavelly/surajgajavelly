<h1> Hi, I'm GAJAVELLY SAI SURAJ!</h1>
<img align='right' src="assets/giphy.gif" width="200">

<!-- <img align= 'right' src="assets/coding.gif" width="120"> -->

<p><em>
Tinkering with <b>microcontrollers</b>, <b>RTOS</b>, and low‑level systems.<br/>
Dreaming in C and chasing performance down to the last clock cycle ⚡
</em></p>

<p>
I'm an Electronics Engineer who loves turning <b>bare‑metal hardware</b> into responsive systems.  
For me, embedded programming feels like teaching silicon to think and breathe — from configuring registers to orchestrating real‑time schedulers.  
My goal is to craft efficient, deterministic code that transforms raw circuits into dependable devices we can trust in the real world.
</p>

<p align="left">
  <a href="https://www.linkedin.com/in/gajavelly-sai-suraj-045214352/">
    <img src="https://img.shields.io/badge/LinkedIn-Connect-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn">
  </a>
  <a href="mailto:saisurajgajavelly@gmail.com">
...
```c
struct SpaceCowboy {
    char* role = "Aspiring Embedded Engineer";
    char* code[] = {"C", "Data Structures", "Makefiles"};
    char* tools[] = {"STM32", "FreeRTOS", "GDB", "CMake"};
    char* motto = "Volatile state of mind.";
};
```
<!-- Typing SVG -->
<p align="center">
<img src="https://readme-typing-svg.herokuapp.com?font=Orbitron&size=30&color=FF4500&center=true&vCenter=true&width=600&lines=Booting+up...;Initializing...;Ready+to+code!;+one+bit+at+a+time.;Volatile+state+of+mind." />
</p>

<!-- <p align="center">
<img src="https://readme-typing-svg.herokuapp.com?font=Playfair+Display&size=30&color=FFFFFF&background=000000&center=true&vCenter=true&width=600&lines=Booting+up...;Initializing...;Ready+to+code!;Volatile+state+of+mind.;See+you,+Space+Cowboy..." />
</p> -->
---
